                ...
                <?php if(!empty($cardUserBadges) and count($cardUserBadges)): ?>
                    <div class="d-flex flex-wrap align-items-center justify-content-center mt-30 w-100">
                        <?php $__currentLoopData = $cardUserBadges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="mr-10" data-toggle="tooltip" data-placement="bottom" data-html="true" title="<?php echo (!empty($badge->badge_id) ? nl2br($badge->badge->description) : nl2br($badge->description)); ?>">
...
<?php /**PATH /home/u1584790/public_html/learning/resources/views/web/default/forum/post_card.blade.php ENDPATH**/ ?>