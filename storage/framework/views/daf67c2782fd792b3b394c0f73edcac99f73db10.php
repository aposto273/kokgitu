    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            ...
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">LMS Adua Studio</h1>
                <h5 class="font-weight-normal text-muted-transparent">fully-featured educational platform</h5>
              </div>
              All rights reserved <a class="text-light bb" target="_blank" href="https://course.aduastudio.com">LMS</a> from <a class="text-light bb" target="_blank" href="https://course.aduastudio.com">Adua Studio</a>
            </div>
          </div>
            </div>
...
<?php /**PATH C:\Users\PC\Documents\LMS ADUA STUDIO\learning\learning\learning\resources\views/admin/auth/auth_layout.blade.php ENDPATH**/ ?>