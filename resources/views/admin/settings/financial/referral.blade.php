            ...
            <form action="/admin/settings/main" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="value[affiliate_user_commission]" value="{{ (!empty($itemValue) and !empty($itemValue['affiliate_user_commission'])) ? $itemValue['affiliate_user_commission'] : old('value.affiliate_user_commission') }}" class="form-control text-center @error('value.affiliate_user_commission') is-invalid @enderror" maxlength="3" min="0" max="100">
                    </div>
                    <div class="text-muted text-small mt-1">{{ trans('admin/main.affiliate_user_commission_hint') }}</div>
                    @error('value.affiliate_user_commission')
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="value[store_affiliate_user_commission]" value="{{ (!empty($itemValue) and !empty($itemValue['store_affiliate_user_commission'])) ? $itemValue['store_affiliate_user_commission'] : old('value.store_affiliate_user_commission') }}" class="form-control text-center @error('value.store_affiliate_user_commission') is-invalid @enderror" maxlength="3" min="0" max="100">

                    </div>
                    <div class="text-muted text-small mt-1">{{ trans('admin/main.store_affiliate_user_commission_hint')}}</div>
                    @error('value.store_affiliate_user_commission')
                        <div class="invalid-feedback">
                           {{ $message }}
                        </div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="value[affiliate_user_amount]" value="{{ (!empty($itemValue) and !empty($itemValue['affiliate_user_amount'])) ? $itemValue['affiliate_user_amount'] : old('value.affiliate_user_amount') }}" class="form-control text-center @error('value.affiliate_user_amount') is-invalid @enderror" maxlength="8" min="0">
                    </div>
                    <div class="text-muted text-small mt-1">{{ trans('admin/main.affiliate_user_amount_hint') }}</div>
                    @error('value.affiliate_user_amount')
                        <div class="invalid-feedback">
                           {{ $message }}
                        </div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="value[referred_user_amount]" value="{{ (!empty($itemValue) and !empty($itemValue['referred_user_amount'])) ? $itemValue['referred_user_amount'] : old('value.referred_user_amount') }}" class="form-control text-center @error('value.referred_user_amount') is-invalid @enderror" maxlength="8" min="0">
                    </div>
                    <div class="text-muted text-small mt-1">{{ trans('admin/main.referred_user_amount_hint') }}</div>
                    @error('value.referred_user_amount')
                        <div class="invalid-feedback">
                           {{ $message }}
                        </div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <textarea name="value[referral_description]" class="form-control" rows="6" placeholder="">{{$itemValue['referral_description']}}</textarea>
